...
export default function WhiteLabelSaasForLicenseManagementConsultantPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/cf-white-label-saas-for-license-management-consultant/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb', maxWidth: 980 }}>
      <h2 style={{ marginTop: 0 }}>White-label SaaS for license-management consultants serving multiple cultivators</h2>
      <p style={{ color: '#9ca3af', fontSize: 13 }}>
        Endpoint: <code>/api/cf-white-label-saas-for-license-management-consultant/run</code>. Submit context as text; the backend calls OpenRouter and returns structured JSON.
      </p>
